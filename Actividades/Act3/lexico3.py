...
class LexerApp:
    def __init__(self):
        ...
        self.text_label = tk.Label(text=" ANALIZADOR LÉXICO ", height=2, width=50, font=("Arial", 15,), fg="black")
        ...
        self.analyze_button = tk.Button(self.button_frame, text="Analizar", command=self.analyze_text, bg="green", font=("Arial", 14,))
        self.analyze_button.grid(row=0, column=0, padx=30, pady=10)

        #crea un boton para limpiar el cuadro de texto
        self.clean_button = tk.Button(self.button_frame, text="Limpiar", command=self.clean_text, bg="orange",  font=("Arial", 14,))
        self.clean_button.grid(row=0, column=1, padx=30, pady=10)

        #Crea un boton para salir del programa
        self.exit_button = tk.Button(self.button_frame, text="Salir", command=self.exit_app, bg="red", font=("Arial", 14,))
        ...
        column_widths = (65, 95, 70, 90, 60, 80, 60, 60)  # Define los anchos deseados

        for column, width in zip(columns, column_widths):
            self.tree.column(column, anchor="center", width=width)

        self.text_label = tk.Label(text=" Numero de Elementos ", height=1, width=50, font=("Arial", 15, 'bold'), fg="#141E46") #bg="#141E46")
        ...
        column_widths = (100, 100)  # Define los anchos deseados
